...
def expand_character(encoded_character):
...
def is_character_expanded(character):
    return character.shape != (7,)


def print_character(character):
    heatmap(
        character if is_character_expanded(character) else expand_character(character),
        linewidths=0.2,
        cbar=False,
        square=True,
...
def get_all_fonts(font,expanded=True):
    chosen_font = {
        1 : font_1,
        2 : font_2,
        3 : font_3,
    ...
    return [ expand_character(c).flatten() for c in chosen_font] if expanded else chosen_font
