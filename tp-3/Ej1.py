...
def SimplePerceptronAnd(iterations=500, epochs=100, learning_rate=0.1):
    ...
    nn.train_on_dataset(and_data_set, and_expected_results, iterations, epochs, learning_rate)
...
def SimplePerceptronXor(iterations=500, epochs=100, learning_rate=0.1):
    ...
    nn.train_on_dataset(xor_data_set, xor_expected_results, iterations, epochs, learning_rate)
